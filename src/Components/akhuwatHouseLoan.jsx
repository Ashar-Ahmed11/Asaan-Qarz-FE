  ...
  return (
    <div className="container-fluid px-4 py-4" style={{ maxWidth: "1000px", margin: "0 auto", fontSize:'22px' }}>
      <div className="text-center mb-5">
        ...
        The high cost of traditional mortgages makes it seem like not being able to buy a dream house. Akhuwat Foundation Housing Loan changes that by giving people who need it most a way to borrow money without having to pay interest or deal with any other problems.
        </p>
      </div>
      ...
      <div className="row mb-5 align-items-center">
        <div className="col-lg-7 col-md-6">
          ...
          <ul>
            <li>On the other hand, normal home loans need collateral like land or valuable things, but Akhuwat Foundation's home loans don't need any security. This means that anyone can use it, even if they don't own land or valuable things.</li>
            ...
            <li>Akhuwat Foundation also works to include everyone in the financial system by giving these housing loans to underserved and low-income areas. This gives families the chance to own their own houses, become financially stable, and live in a safer and more respectable place.</li>
      ...
      <div className="row mb-5 align-items-center">
        <div className="col-12">
          <h2 className="fw-bold mb-3 text-center">How to Get a Home Loan from Akhuwat Foundation</h2>
          <ul>
            ...
            <li><strong>Send in Application:</strong> To fill out and send in your loan application, go to the Akhuwat Foundation office that is closest to you.</li>
            <li><strong>Review of Your Application:</strong> The Akhuwat Foundation team will carefully look over your application. If accepted, you'll be told right away.</li>
